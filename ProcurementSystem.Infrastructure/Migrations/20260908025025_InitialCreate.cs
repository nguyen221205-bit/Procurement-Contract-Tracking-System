        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BidPackages_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BidPackageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BidDocuments_BidPackages_BidPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvaluationCriteria_BidPackages_BidPackageId",
                        column: x => x.BidPackageId,
                        principalTable: "BidPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BidSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BidSubmissions_BidPackages_BidPackageId",
                        column: x => x.BidPackageId,
                        principalTable: "BidPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BidSubmissions_Contractors_ContractorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Terms = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ScannedFilePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BidSubmissionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvaluationScores_BidSubmissions_BidSubmissionId",
                        column: x => x.BidSubmissionId,
                        principalTable: "BidSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EvaluationScores_Users_EvaluatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmissionFiles_BidSubmissions_BidSubmissionId",
                        column: x => x.BidSubmissionId,
                        principalTable: "BidSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressUpdates_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Acceptances_ContractMilestones_MilestoneId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Acceptances_Users_ApprovedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Acceptances_ApprovedBy",
                table: "Acceptances",
                column: "ApprovedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Acceptances_MilestoneId",
                table: "Acceptances",
                column: "MilestoneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BidDocuments_BidPackageId",
                table: "BidDocuments",
                column: "BidPackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BidPackages_CreatedBy",
                table: "BidPackages",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_BidPackages_Deadline",
                table: "BidPackages",
                column: "Deadline");

            migrationBuilder.CreateIndex(
                name: "IX_BidPackages_Status",
                table: "BidPackages",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_BidSubmissions_BidPackageId_ContractorId",
                table: "BidSubmissions",
                columns: new[] { "BidPackageId", "ContractorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BidSubmissions_ContractorId",
                table: "BidSubmissions",
                column: "ContractorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationCriteria_BidPackageId",
                table: "EvaluationCriteria",
                column: "BidPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationScores_BidSubmissionId_CriteriaId_EvaluatorId",
                table: "EvaluationScores",
                columns: new[] { "BidSubmissionId", "CriteriaId", "EvaluatorId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationScores_EvaluatorId",
                table: "EvaluationScores",
                column: "EvaluatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressUpdates_ContractId_WeekNumber",
                table: "ProgressUpdates",
                columns: new[] { "ContractId", "WeekNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubmissionFiles_BidSubmissionId",
                table: "SubmissionFiles",
                column: "BidSubmissionId");
